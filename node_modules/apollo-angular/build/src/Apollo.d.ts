...
import { ApolloClient, ApolloQueryResult, WatchQueryOptions, MutationOptions, SubscriptionOptions, ApolloExecutionResult } from 'apollo-client';
...
export declare class ApolloBase {
    ...
    mutate<T>(options: MutationOptions): Observable<ApolloExecutionResult<T>>;
